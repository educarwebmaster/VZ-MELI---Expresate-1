...
{
    [Header("MARCADOR")] public int ID;

    public GameObject Me;

    [Header("VIDEO")] public bool Video = false;
    ...
    [Header("TEXTO INFORMATIVO")] public bool Texto_informativo;
    public string Texto;

    [Header("TOUSH")] public bool Touch = false;
    ...
    [Header("GENERALES")] public string AnimacionRestablecer;
    public AudioSource AudioControler;
    public AudioClip AudioRecurso;

    [Header("ARRASTRAR OBJETO")] private int EstadoTouchGui;
    private float Alpha;

    [Header("Google")] Vector3 dist;
    float posX;
    float posY;
    bool comodin_agrandar = false;
    float n_TAMA = 0;

    [HideInInspector] public int video_mos = 0;
    ...
    void Start() {
        ...
        Tamano_inicial =
            new Vector3(transform.localScale.x, transform.localScale.y,
                transform.localScale.z); //Capturar el tamaño inicial del objeto
    ...
    void Update() {
        ...
        if (Input.touchCount == 2) {
            ...
            if (Elemento_3D) {
                ...
                transform.localScale = new Vector3(Tamano_inicial.x + ((TAMA) - (n_TAMA)),
                    Tamano_inicial.y + ((TAMA) - (n_TAMA)), Tamano_inicial.z + ((TAMA) - (n_TAMA)));
                transform.localEulerAngles =
                    new Vector3(transform.localRotation.x, rotacion, transform.localRotation.z);
            }
        }
        else {
