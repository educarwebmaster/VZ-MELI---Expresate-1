namespace Recursos.MELI.AI_MELI_MOD1_ANIMALES_EN_LA_MIRA.Scripts.AI_MELI_MOD1_ANIMALES_EN_LA_MIRA.Misc {
    ...
    public static class TAGS
    {
        ...
        public static string INICIO_TAG = "inicio";
        public static string INFORMACION_TAG = "informacion";
        public static string PLAYER_TAG = "Player";
        public static string COIN_RIGHT = "CoinRight";
        public static string COIN_WRONG = "CoinWrong";
