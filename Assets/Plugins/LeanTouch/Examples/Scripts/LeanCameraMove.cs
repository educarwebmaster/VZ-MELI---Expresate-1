...
namespace Lean.Touch {
    ...
    public class LeanCameraMove : MonoBehaviour {
        ...
        protected virtual void LateUpdate() {
            ...
            if (worldDelta.x <= OffsetRight) {
//                worldDelta.x = OffsetRight;
//            }
//
//            else if (worldDelta.x >= OffsetLeft) {
//                worldDelta.x = OffsetLeft;
//            }
//
//            else if (worldDelta.y <= OffsetUP) {
//                worldDelta.y = OffsetUP;
//            }
//
//            else if (worldDelta.y >= offsetDown) {
//                worldDelta.y = offsetDown;
//            }
